...
void CommandTableStorage::Init()
{
	...
	static ChatCommand commandTable[] =
	{
		...
		{ "aura",			 'm', &ChatHandler::HandleAddAuraCommand,							"Adds aura on target.",                                                                                                           NULL,                     0, 0, 0 },
		...
		{ "castself",		 'm', &ChatHandler::HandleCastSelfCommand,						"Forces target to cast specified spell on self. <spell id> <triggered>.",                                                                                                           NULL,                     0, 0, 0 },
		{ "casttarget",		 'm', &ChatHandler::HandleCastTargetCommand,					"Forces target to cast specified spell on at target. <spell id> <triggered>.",                                                                                                           NULL,                     0, 0, 0 },
		{ "channel",		 'm', &ChatHandler::HandleChannelCommand,						"Channels specified spell at target.",                                                                                                           NULL,                     0, 0, 0 },
