...
enum SpellImplicitTargetType
{
	...
	SPELL_TARGET_BACK					= 0x00400000,
	SPELL_TARGET_RIGHT					= 0x00800000,
	SPELL_TARGET_LEFT					= 0x01000000,
	SPELL_TARGET_FRONT_RIGHT			= 0x02000000,
	SPELL_TARGET_BACK_RIGHT				= 0x04000000,
	SPELL_TARGET_BACK_LEFT				= 0x08000000,
	SPELL_TARGET_FRONT_LEFT				= 0x10000000,
};
