...
const char* spellentryFormat = "uiiiiiiiiiiiixixiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiifxiiiiiiiiiiiiiiiiiiiiiiiiiiiifffiiiiiiiiiiiiiiiiiiiiifffiiiiiiiiiiiiiiifffiiiiiiiiiiiiixssssssssssssssssxssssssssssssssssxsxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxiiiiiiiiiiixfffxxxiiiiixxfffxx";
...
const char* scalingstatdistributionformat = "uiiiiiiiiiiiiiiiiiiiii";
const char* scalingstatvaluesformat = "uiiiiiiiiiiiiiiiiiiiiiii";
